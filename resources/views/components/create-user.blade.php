    ...
    <form class="card" id="{{ isset($formId) && $formId ? $formId : 'form' }}" action="{{ url($formAction) }}" method="{{ $formMethod != 'GET' ? 'POST' : 'GET' }}" enctype="multipart/form-data">
        ...
        <div class="card-body">
            ...
            <div class="form-group mb-3">
                ...
                @if($isEdit)
                <br /><img src="{{ 'storage'.$dataUser->photo }}" alt="foto pengguna">
                @endif
            ...
            @if($isEdit)
            <div class="form-group mb-3">
                <label for="old_password">Password Lama (opsional)</label>
                <input type="password" name="old_password" id="old_password" class="form-control @error('old_password') is-invalid @enderror" placeholder="Password Lama" />
                @error('old_password')
                    <div class="text-danger">{{ $message }}</div>
                @enderror
            </div>
            @endif
            <div class="form-group mb-3">
                <label for="password">Password @if($isEdit)(opsional)@endif</label>
            ...
            <div class="form-group mb-3">
                <label for="password_confirmation">Konfirmasi Password @if($isEdit)(opsional)@endif</label>
            ...
            <div class="form-group mb-3">
                ...
                <input type="text" name="nik" id="nik" class="form-control @error('nik') is-invalid @enderror only-number" placeholder="NIK" value="{{ old('nik', ($dataUser ? $dataUser->nik : '')) }}" required />
                @error('nik')
                    <div class="text-danger">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="form-group mb-3">
                ...
                <input type="text" name="nip" id="nip" class="form-control @error('nip') is-invalid @enderror" placeholder="NIP" value="{{ old('nip', ($dataUser ? $dataUser->nip : '')) }}" required />
                @error('nip')
                    <div class="text-danger">{{ $message }}</div>
                @enderror
            </div>
            <div class="form-group mb-3">
                ...
                <input type="text" name="nuptk" id="nuptk" class="form-control @error('nuptk') is-invalid @enderror" placeholder="NUPTK" value="{{ old('nuptk', ($dataUser ? $dataUser->nuptk : '')) }}" required />
                @error('nuptk')
                    <div class="text-danger">{{ $message }}</div>
                @enderror
            </div>
            <div class="form-group mb-">
                ...
                <input type="text" name="jenis_ptk" id="jenis_ptk" class="form-control @error('jenis_ptk') is-invalid @enderror" placeholder="Jenis PTK" value="{{ old('jenis_ptk', ($dataUser ? $dataUser->jenis_ptk : '')) }}" required />
                @error('jenis_ptk')
                    <div class="text-danger">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="form-group mb-3">
                ...
                <input type="text" name="full_name" id="full_name" class="form-control @error('full_name') is-invalid @enderror" placeholder="Nama Lengkap" value="{{ old('full_name', ($dataUser ? $dataUser->full_name : '')) }}" required />
                @error('full_name')
                    <div class="text-danger">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="form-group mb-3">
                ...
                <input type="text" name="phone_number" id="phone_number" class="form-select only-number @error('phone_number') is-invalid @enderror" placeholder="Nomor Telepon" value="{{ old('phone_number', ($dataUser ? $dataUser->phone_number : '')) }}" required />
                @error('phone_number')
                    <div class="text-danger">{{ $message }}</div>
                @enderror
            </div>
            <div class="form-group mb-3">
                ...
                <input type="text" name="address" id="address" class="form-control @error('address') is-invalid @enderror" placeholder="Alamat" value="{{ old('address', ($dataUser ? $dataUser->address : '')) }}" required />
                @error('address')
                    <div class="text-danger">{{ $message }}</div>
                @enderror
            </div>
            <div class="form-group mb-3">
                ...
                <input type="text" name="religion" id="religion" class="form-control @error('religion') is-invalid @enderror" placeholder="Agama" value="{{ old('religion', ($dataUser ? $dataUser->religion : '')) }}" required />
                @error('religion')
                    <div class="text-danger">{{ $message }}</div>
                @enderror
            </div>
