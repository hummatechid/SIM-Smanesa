...
<html lang="en">
    <head>
        ...
        <link
            rel="stylesheet"
            href="{{ asset('assets/compiled/css/auth.css') }}"
        />
        <link
            rel="stylesheet"
            href="{{
    ...
    <body>
                    ...
                    <div id="auth-left">
                        <div class="d-lg-none d-block mb-5">
                            ...
                            >
                                <img
                                    src="{{
                                        asset('assets/compiled/logos/logo.png')
                                    }}"
                                    alt="Logo"
                                    height="50"
                                />
                        ...
                        <p class="auth-subtitle mb-5">
                            Masuk ke akun anda untuk menuju halaman beranda
                        </p>
                        ...
                        >
                            ...
                            >
                                ...
                                <button
                                    type="button"
                                    class="btn-password position-absolute end-0 px-3 bg-transparent border-0"
                                    style="top: 9px"
                                >
                                    <i
                                        class="bi bi-eye-fill fs-3 text-muted"
                                    ></i>
                                </button>
                            </div>
                            <button
                ...
                <div class="col-lg-7 d-none d-lg-block">
                    ...
                    >
                        <img
                            ...
                            alt="{{ asset('assets/compiled/logos/logo.png') }}"
                            width="150"
                            height="150"
                        />
                        <div class="text-white text-center fw-bold fs-4">
                            SMAN 1 Purwosari
                        </div>
                        <div class="text-white text-center lead">
        ...
        <script src="{{
                asset('assets/extensions/parsleyjs/parsley.min.js')
            }}"></script>
        <script src="{{
                asset('assets/extensions/parsleyjs/i18n/id.js')
            }}"></script>
        <script src="{{
                asset('assets/extensions/parsleyjs/i18n/id.extra.js')
            }}"></script>
        <script src="{{
                asset('assets/extensions/sweetalert2/sweetalert2.min.js')
            }}"></script>
        <script>
